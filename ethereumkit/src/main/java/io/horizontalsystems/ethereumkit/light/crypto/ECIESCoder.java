...
import io.horizontalsystems.ethereumkit.light.net.ConcatKDFBytesGenerator;

import static io.horizontalsystems.ethereumkit.light.crypto.ECKey.CURVE;
...
//        }
     ...
     * Used for Whisper V3
     */
    public static byte[] encryptSimple(ECPoint pub, byte[] plaintext) throws
...
//        };
    ...
    private static EthereumIESEngine makeIESEngine(boolean isEncrypt, ECPoint pub, BigInteger
            prv, byte[] IV) {
        AESEngine aesFastEngine = new AESEngine();
