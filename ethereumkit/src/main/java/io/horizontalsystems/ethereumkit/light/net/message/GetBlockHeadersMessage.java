...
import static io.horizontalsystems.ethereumkit.light.util.ByteUtil.byteArrayToInt;
import static io.horizontalsystems.ethereumkit.light.util.ByteUtil.byteArrayToLong;
 ...
 * @since 04.09.2015
 */
public class GetBlockHeadersMessage extends LesMessage {
...
//    }
    ...
    public GetBlockHeadersMessage(long requestID, long blockNumber, byte[] blockHash, int maxHeaders, int skipBlocks, boolean reverse) {
    ...
    private void encode() {
        ...
        this.encoded = RLP.encodeList(reqID, this.encoded);
    }
    ...
    public LesMessageCodes getCommand() {
        return LesMessageCodes.GET_BLOCK_HEADERS;
    }
